...
# Graph fragment:
#   %mul_1 : [num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%tangents_1, 2), kwargs = {})
...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        triton_poi_fused_mul_0.run(tangents_1, buf0, 100, grid=grid(100), stream=stream0)
        del tangents_1
    return (buf0, )
